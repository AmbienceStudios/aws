...
function SetupEnvironment()
{
    ...
    mFrontLight.castShadow = true; // default false
    ...
    mBackLight.castShadow = true; // default false
...
function LoadAventador(config)
{
    ...
    function ( gltf ) 
    {
        ...
        boxer.scene.traverse(function(obj)
        {
    ...
    $('.nav-config-item',config_palette).click(function()
    {
        ...
        if(configID=='wheel_designs')     
        {
            AddTextureSwatches($('#'+configID+" ul",config_palette),mConfigJSON[configID],function(targetName)
            {
                ...
                SetEntityVisible(boxer.scene,targetName);
...
function SetOrbitCamera()
{
    ...
    // mOrbitcontrols.addEventListener('mousedown',myOnMouseDownFunction ,false);
